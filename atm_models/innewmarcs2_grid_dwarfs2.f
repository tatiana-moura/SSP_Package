...
c
	...
	Character*52 Nomfiple
        Dimension RTeff(22),IDT(22),ING(22),JG1(22),JG2(22),RGlog(22),
     1            R1Teff(22)
    	Dimension IDTA(22),INGA(22)
     ...
     4           AGloga17(5),AGloga18(5),AGloga19(5),AGloga20(5),
     2           AGloga21(5),AGloga22(5),AGloga23(5),AGlog(22,22)
          
        data R1Teff /2900., 3100., 3300., 3500., 
     1        3700., 3900., 4000., 4250., 4500., 4750., 5000., 
     2        5250., 5500., 5750., 6000., 6250., 6500., 
     3        7000., 7250., 7500., 7750., 8000/ 
c
c	
        ...
        data AGloga11 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga12 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga13 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga14 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga15 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga16 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga17 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga18 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga19 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga20 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga21 /3.0, 3.5, 4.0, 4.5, 5.0/
        data AGloga22 /3.0, 3.5, 4.0, 4.5, 5.0/
c	aqui deve-se detalhar a linha de inicio para cada temp
        data IDTa /1, 6, 11, 16, 21, 26, 31, 36, 41, 46,
     1          51, 56, 61, 66, 71, 76, 81, 86, 91, 96, 101, 106/
...
c        Entree dans le SP locatab
	...
	NT=22    ! nbre total de temperatures
	...
	AGlog(18,n)=AGloga13(n)
	AGlog(19,n)=AGloga14(n)
	AGlog(20,n)=AGloga15(n)
	AGlog(21,n)=AGloga16(n)
	AGlog(22,n)=AGloga17(n)
	end do
