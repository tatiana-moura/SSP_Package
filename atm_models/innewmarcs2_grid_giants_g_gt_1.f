...
c
	...
	Character*52 Nomfiple
        Dimension RTeff(19),IDT(19),ING(19),JG1(19),JG2(19),RGlog(19),
     1            R1Teff(19)
    	Dimension IDTA(19),INGA(19)
    	Dimension AGloga1(5),AGloga2(5),AGloga3(5),AGloga4(5),
     1           AGloga5(5),AGloga6(5),AGloga7(5),AGloga8(5),
     2           AGloga9(5),AGloga10(5),AGloga11(5),AGloga12(5),
     3           AGloga13(5),AGloga14(5),AGloga15(5),AGloga16(5),
     2           AGloga17(5),AGloga18(5),AGloga19(5),AGlog(19,19)
          
        data R1Teff /2600., 2800., 2900., 3000., 3100., 3200.,
     1         3300., 3400., 3500., 3600., 3700., 3800., 3900., 
     2         4000., 4250., 4500., 4750., 5000., 5250/ 
c
c	
        data AGloga1 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga2 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga3 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga4 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga5 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga6 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga7 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga8 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga9 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga10 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga11 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga12 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga13 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga14 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga15 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga16 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga17 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga18 /1.0, 1.5, 2.0, 2.5, 3.0/
        data AGloga19 /1.0, 1.5, 2.0, 2.5, 3.0/
c        data AGloga20 /1.0, 1.5, 2.0, 2.5, 3.0/
c	aqui deve-se detalhar a linha de inicio para cada temp
        data IDTa /1, 6, 11, 16, 21, 26, 31, 36, 41, 46,
     1          51, 56, 61, 66, 71, 76, 81, 86, 91/
...
c        Entree dans le SP locatab
	...
	NT=19    ! nbre total de temperatures
	...
	AGlog(12,n)=AGloga12(n)
	AGlog(13,n)=AGloga13(n)
	AGlog(14,n)=AGloga14(n)
	AGlog(15,n)=AGloga15(n)
	AGlog(16,n)=AGloga16(n)
	AGlog(17,n)=AGloga17(n)
	AGlog(18,n)=AGloga18(n)
	AGlog(19,n)=AGloga19(n)
