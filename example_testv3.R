...
n_rg = 8          # number of desired red giant stars
feh = 0.2         # [Fe/H]
afe = 0.1         # [alpha/Fe]
age = 12.5        # age (Gyr)
lmin = 8400       # lower lambda
lmax = 8600       # upper lambda
imf = 'Kroupa'    # IMF
...
# 
# # legend(8400, 0.68, c('[Ca/Fe] = [a/Fe] = 0.1, Kroupa', 
