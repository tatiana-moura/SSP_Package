...
C
	INTEGER*4 CALLAM,CALTH
     ...
     1PO(2),CUK(2),CONS(2),AN(2),C1(3),C2(3),C3(3),C4(3),C8(3),C6(3),EXP
     2 ON(2)
	...
	45),ZEXP(10),UL
     ...
     497997,8.900841,-20.84862/,C8/0.0,-17.78231,0.0/,C6/0.0,-7.89472E-2
	5,0.0/
C
...
5560	IF (K.EQ.2) ZNL1=ZNL
	IF (K.NE.2) ZNL1=1.0
      ANU=EXP(((((C1(K)*ZNL+C2(K))*ZNL+C3(K))*ZNL+C4(K))*ZNL1+C8(K))*ZNL
	11+C6(K))*1.0E-18
	GO TO 5730
5620	N=1
C
...
C
	...
	1 GFAL(NR),ABOND(NR),KA(NR),KAP(50),
...
C
	...
	PARAMETER(NR=8000)
	DIMENSION ELE(100),ABO(100),ELEM(NR),ABOND(8000)
