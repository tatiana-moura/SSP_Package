...
c
	...
	Character*52 Nomfiple
     ...
     1            R1Teff(4)
    	Dimension IDTA(4),INGA(4)
    	Dimension AGloga1(4),AGloga2(4),AGloga3(4),AGloga4(4),
     1           AGloga5(5),AGloga6(5),AGloga7(5),AGloga8(5),
     2           AGloga9(5),AGloga10(5),AGlog(10,10)
          
        data R1Teff /3300., 3500., 3700., 3900./ 
c
c	
        data AGloga1 /-0.5, +0.0, +0.5, +1.0/
        data AGloga2 /-0.5, +0.0, +0.5, +1.0/
        data AGloga3 /-0.5, +0.0, +0.5, +1.0/
        data AGloga4 /-0.5, +0.0, +0.5, +1.0/ 
c        data AGloga5 /3.0, 3.5, 4.0, 4.5, 5.0/
c        data AGloga6 /3.0, 3.5, 4.0, 4.5, 5.0/
c        data AGloga7 /3.0, 3.5, 4.0, 4.5, 5.0/
c        data AGloga8 /3.0, 3.5, 4.0, 4.5, 5.0/
c        data AGloga9 /3.0, 3.5, 4.0, 4.5, 5.0/
c        data AGloga10 /3.0, 3.5, 4.0, 4.5, 5.0/
...
c        Entree dans le SP locatab
	...
	NT=4    ! nbre total de temperatures
	NG=4    ! nbre maximum de log g
	Do n=1,nt
	Rteff(n)=R1Teff(n)
	ING(n)=INGa(n)
	IDT(n)=IDTa(n)
